...
import { NavLink } from 'react-router-dom';//react er moddhe a er poriborte NavLink and href er jaigai to use hoi//
                ...
                <div className="row">
                    <div className="col-10 mx-auto">
                        ...
                        <nav className="navbar navbar-expand-lg navbar-light bg-light">
                            <NavLink className="navbar-brand" to="/">Hasnat Apu</NavLink>
